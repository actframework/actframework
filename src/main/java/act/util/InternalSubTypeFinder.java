...
@ActComponent
public abstract class InternalSubTypeFinder extends AppCodeScannerPluginBase {
    ...
    protected InternalSubTypeFinder(boolean publicOnly, boolean noAbstract, Class<?> superType, $.Func2<App, String, Map<Class<? extends AppByteCodeScanner>, Set<String>>> foundHandler) {
    ...
    protected InternalSubTypeFinder(Class<?> superType, $.Func2<App, String, Map<Class<? extends AppByteCodeScanner>, Set<String>>> foundHandler) {
    ...
    private class ByteCodeSensor extends AppByteCodeScannerBase {
        ...
        private $.Func2<App, String, Map<Class<? extends AppByteCodeScanner>, Set<String>>> foundHandler = InternalSubTypeFinder.this.foundHandler;
