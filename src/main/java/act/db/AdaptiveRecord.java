...
public interface AdaptiveRecord<ID_TYPE, MODEL_TYPE extends AdaptiveRecord> extends Model<ID_TYPE, MODEL_TYPE> {
    ...
    class Util {
        ...
        public static Map<String, Object> toMap(final AdaptiveRecord ar) {
            Map<String, Object> kv = ar.internalMap();
        ...
        private static int fieldsSize(final AdaptiveRecord ar) {
            return ar.metaInfo().getterFieldSpecs.size();
        }

        public static int size(final AdaptiveRecord ar) {
            Map<String, Object> kv = ar.internalMap();
        ...
        public static Set<Map.Entry<String, Object>> entrySet(AdaptiveRecord ar, Osgl.Function<BeanSpec, Boolean> function) {
            ...
            AdaptiveRecord.MetaInfo metaInfo = ar.metaInfo();
        ...
        public static AdaptiveRecord.MetaInfo generateMetaInfo(AdaptiveRecord ar) {
            AdaptiveRecord.MetaInfo.Repository r = Act.appServicePluginManager().get(AdaptiveRecord.MetaInfo.Repository.class);
            return r.get(ar.getClass(), new $.Transformer<Class<? extends AdaptiveRecord>, AdaptiveRecord.MetaInfo>() {
                @Override
