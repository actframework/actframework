...
public interface ProjectLayout {
    ...
    public static  enum PredefinedLayout implements ProjectLayout {
         ...
         * </pre>
         * <b>{@code MAVEN} layout is used only when OMS running in {@link org.osgl.oms.OMS.Mode#DEV dev mode}</b>
         */
        MAVEN() {
            @Override
         ...
         * </pre>
         * <b>{@code PLAY} layout is used only when OMS running in {@link org.osgl.oms.OMS.Mode#DEV dev mode}</b>
         */
        PLAY() {
            @Override
            public File source(File appBase) {
