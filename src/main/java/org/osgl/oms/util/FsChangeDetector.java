...
public class FsChangeDetector {
    ...
    private void walkThrough(File file, Map<String, Long> timestamps, _.Var<Long> checksum) {
        if (file.isDirectory()) {
            ...
            if (!file.exists()) {
                throw new OmsException("File deleted: %s", dir);
            }
