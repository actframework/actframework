 ...
 */
public class ActionMethodMetaInfoL {
    ...
    public ActionMethodMetaInfoL name(String name) {
        this.name = name;
    ...
    public ActionMethodMetaInfoL appContextBy(AppContextBy by) {
        appContextBy = by;
        return this;
    }
    ...
    public ActionMethodMetaInfoL invokeType(InvokeType type) {
        this.invokeType = type;
        return this;
    }

    public ActionMethodMetaInfoL returnType(Type type) {
    ...
    public ActionMethodMetaInfoL appContextIndex(int index) {
    ...
    public ActionMethodMetaInfoL addParam(ParamMetaInfo param) {
        params.add(param);
    ...
    public ActionMethodMetaInfoL addLocal(LocalVariableMetaInfo local) {
