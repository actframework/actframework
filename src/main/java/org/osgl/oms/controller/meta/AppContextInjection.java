...
/**
 * Keep all information required to inject {@link org.osgl.oms.app.AppContext}
...
public class AppContextInjection<T> {
    ...
    public static enum InjectType {
         ...
         * {@code AppContext}, then framework shall call {@link org.osgl.oms.app.AppContext#saveLocal}
         * method to save the app context instance into thread local variable, such that the
         * application developer could use {@link org.osgl.oms.app.AppContext#get} method to
