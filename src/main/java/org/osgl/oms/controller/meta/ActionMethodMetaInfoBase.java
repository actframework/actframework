...
/**
 * Common meta data storage for both {@link org.osgl.oms.controller.RequestDispatcher}
 * and {@link org.osgl.oms.controller.Interceptor}
 */
public abstract class ActionMethodMetaInfoBase<T extends ActionMethodMetaInfoBase> {
    private String name;
    ...
    public T noReturn() {
        returnType = ReturnTypeInfo.noReturn();
        return me();
    }
    ...
    public ActionMethodMetaInfoBase addParam(ParamMetaInfo param) {
        params.add(param);
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof ActionMethodMetaInfoBase) {
            ActionMethodMetaInfoBase that = (ActionMethodMetaInfoBase) obj;
